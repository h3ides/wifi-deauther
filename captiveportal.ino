...
String postedSSID() {
  ...
  // ✅ Confirmation page with auto-redirect after 5 seconds
  return "<!DOCTYPE html><html><head>"
         "<meta http-equiv=\"refresh\" content=\"5;url=/\">"
         "<meta name=viewport content=\"width=device-width,initial-scale=1\">"
         "<meta charset=\"UTF-8\">"
         "<title>SSID Updated</title></head><body>"
         "<h1>SSID Updated</h1>"
         "<p>SSID changed to <b>" + postedSSID + "</b>.</p>"
         "<p>You will be redirected to the home page in 5 seconds.</p>"
         "<center><a style=\"color:blue\" href=/>Back to Index</a></center>"
         "</body></html>";
}
